...
item1 = html.Div(
    [
        html.P("-Welcome to the Stock Predictor Dash app-", className="start"),
        html.Div([
            # stock code input
            dcc.Input(id='stock-code', type='text', placeholder='Enter stock name'),
        ...
        html.P("Sakshi Semwal, CST-SPL1, Roll no- 38, 6th semester")
    ],
    className="nav"
)
